...
function EditUser() {
  ...
  const { value: device, onChange: onChangeaDevice } = useInput();
  const [role, setPersonName] = React.useState([]);
  ...
  const onChangeCheckbox = (event, roleName) => {
    ...
    newRoleList.forEach((rolesValue) => {
      if (rolesValue.name === roleName) {
        rolesValue.checkboxList.forEach((item) => {
                ...
                <Grid item lg={4} xs={4}>
                  ...
                  <div className={classes.field}>
                    ...
                    <TextField
                      ...
                      size="small"
                      type="text"
                      defaultValue="vominhtam@gmail.com"
                      autoComplete="current-password"
                      variant="outlined"
                      fullWidth
                      className={classes.fieldText}
                ...
                <Grid item lg={4} xs={4}>
                  ...
                  <div className={classes.field}>
                    ...
                    <TextField
                      ...
                      size="small"
                      defaultValue="15 Nguyen Van Cu, Quan 5, Thanh pho Ho Chi Minh"
                      type="text"
                      autoComplete="current-password"
                      variant="outlined"
                      fullWidth
